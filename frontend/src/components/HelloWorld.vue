  ...
  <v-container>
    ...
    >
      ...
      >
        ...
        <p style="strong;color:green" v-if="$store.app.socket_connected"> Socket is connected!</p>
        <p style="strong;color:red" v-else> Socket is not connected.</p>
        <p></p>
